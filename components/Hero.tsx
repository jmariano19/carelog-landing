...
export default function Hero() {
  ...
  return (
    <>
      <section className="min-h-[380px] sm:min-h-[460px] flex flex-col items-center justify-center px-5 sm:px-4 text-center bg-[#fbf6ee] py-12 sm:py-0">
        {/* Main heading with fade animation */}
        <h1
          key={lang}
          className="font-serif text-[clamp(36px,10vw,51px)] font-bold leading-[1.25] tracking-[-0.4px] text-[#2d2926] w-full max-w-[420px] mx-auto mb-6 overflow-visible animate-fadeIn"
        >
          {titleContent}
        </h1>
        ...
        <p
          key={`sub-${lang}`}
          className="font-sans text-[clamp(18px,5.5vw,23px)] font-light leading-[1.5] tracking-[-0.4px] text-[#2d2926] w-full max-w-[323px] mx-auto animate-fadeIn animation-delay-100"
        >
          {t.hero.sub}
        </p>
      </section>
      ...
      <div className="w-full bg-[#f0ebe3] py-4">
        <div className="max-w-[420px] mx-auto px-5 sm:px-6 flex items-center justify-center gap-3">
